...
def get_volunteers_by_ngo(ngo_id):
    try:
        # Nota para avaliação dos alunos: Operação Scan simplificada
        # para fins de desenvolvimento. Em cenários complexos de produção,
        # índices globais secundários (GSI) seriam exigidos.
        response = table.scan(
